  ...
  <div class="max-w-[1400px] mx-auto">
    <div class="grid grid-cols-2 md:grid-cols-5 gap-12 mb-24">
      ...
      <div class="flex flex-col gap-4">
        ...
        <a href="/" class="hover:text-gray-300">Vaults</a>
        <a href="/" class="hover:text-gray-300">Strategies</a>
        <a href="/" class="hover:text-gray-300">Supported Chains</a>
      </div>
      ...
      <div class="flex flex-col gap-4">
        ...
        <a href="/" class="hover:text-gray-300">Audits</a>
      </div>
      ...
      <div class="flex flex-col gap-4">
        ...
        <a href="/" class="text-gray-400 hover:text-gray-300">Risk Disclosure</a>
      </div>

      <!-- Col 5 (Contact) -->
      <div class="flex flex-col gap-4 items-start md:items-end">
        <a href="mailto:support@blend.finance" class="font-medium border-b border-white pb-0.5 hover:opacity-80">support@blend.finance</a>
        <a href="/" class="font-medium border-b border-white pb-0.5 hover:opacity-80">@blendfinance</a>
      </div>
    </div>
    ...
    <div class="border-t border-gray-900 pt-12 text-[11px] text-gray-600 leading-relaxed flex flex-col gap-6">
      <p>
        Blend is a decentralized finance protocol. All investments in DeFi carry risk, including potential loss of principal. Past performance is not indicative of future results.
      </p>
      <p>
        Blend does not provide financial, investment, tax, or legal advice. The information provided on this website is for informational purposes only and should not be relied upon as a substitute for professional advice. Users are responsible for conducting their own research and due diligence before making any investment decisions. DeFi protocols involve smart contract risk, market volatility, and other risks that could result in partial or total loss of funds.
      </p>
      <p>
        By using Blend's services, you acknowledge that you understand the risks associated with decentralized finance and cryptocurrency investments. Blend's smart contracts are non-custodial, meaning you maintain full control of your assets at all times. Always ensure you understand the risks before depositing funds into any DeFi protocol.
      </p>
    </div>

    <div class="mt-12 flex items-center gap-4 text-xs text-gray-600">
