    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
      <div class="lg:col-span-7">
        <h1 class="font-serif text-5xl md:text-6xl lg:text-[64px] leading-[1.1] tracking-tight text-gray-900">
          Maximize yield across currencies with automated rebalancing
        </h1>
      </div>
      <div class="lg:col-span-5 flex flex-col justify-between">
        <p class="text-gray-500 text-lg max-w-md leading-relaxed">
          Blend optimizes your DeFi yields through cross-chain rebalancing and delta-neutral hedging strategies. Save globally, spend locally.
        </p>
      </div>
    </div>
